...
### [팝업스토어 검색하기]
- 팝업스토어 관리하기 클릭 후 검색창에 검색하면 해당 검색어와 맞는 팝업스토어가 나옵니다.
- 한 페이지에 15개가 출력되고 15개가 넘어가면 페이징 처리가 되어 넘어갑니다.
- 마우스 오버 시 분홍색으로 바뀝니다.
...
### [굿즈 검색하기]
- 쇼핑몰 관리하기 클릭 후 검색창에 검색하면 해당 검색어와 맞는 굿즈가 나옵니다.
- 마우스 오버 시 분홍색으로 바뀝니다.
...
### [전시회 검색하기]
- 전시회 관리하기 클릭 후 검색창에 검색하면 해당 검색어와 맞는 전시회가 나옵니다.
- 한 페이지에 14개가 출력되고 14개가 넘어가면 페이징 처리가 되어 넘어갑니다.
- 마우스 오버 시 분홍색으로 바뀝니다.
